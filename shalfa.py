...
print('# Shalfa v0.1 | Coded by: Abdullah AlZahrani GitHub.com/0xAbdullah')
parser = argparse.ArgumentParser(description="[*] Shalfa is an open source web application security scanner.")
...
if len(sys.argv) == 1:
    sys.exit("[!] Usage: python3 shalfa.py -u https://example.com")
